...
// http://javascript-source.com
//***********************************************
wowReInitor(jQuery("#wowslider-container1"),{effect:"fade"//basic,blast,blinds,blur,fade,fly,kenburns,rotate,slices,squares,stack
,prev:"",next:"",duration:5000,delay:50*200,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:true,controls:false,logo:"",images:0,pagination:false});