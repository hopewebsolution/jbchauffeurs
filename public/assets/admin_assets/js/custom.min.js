...
$(document).ready(function($) {
    $(document).on('click', '.pagination a', function (e) {
        getTableAjaxData($(this).attr('href'));
        e.preventDefault();
    });
    
});
function getTableAjaxData(ajaxurl,out_put_obj="#ajax_data") {
  	var pageurl="";
  	var out_put=out_put_obj;
  	if(ajaxurl!=""){
    	pageurl=ajaxurl;
  	}
  	$(out_put).append($(".loader_html").html());
  	$.ajax({
      	url : pageurl,
      	dataType: 'json',
  	}).done(function (data) {
      	$(out_put).html(data);
      	//$(out_put+".ajax-loader").remove();
      	window.history.pushState('page2', 'Title', pageurl);
  	}).fail(function () {
    	//window.location.href="";
  	});
}

/*Script For Previewing Image On Choose File*/
