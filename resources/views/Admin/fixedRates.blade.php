...
@section('content')
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>All Fixed Rates</h2>
          <div class="navbar-right">
              <a href="{{ route('admin.fixedRates.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Add New</a>
          </div>
...
<script>
  $(document).ready(function(){
    $('.searchInput').on('keyup', function(){
      ...
      $.ajax({
        url : "{{ route('admin.fixedRates.search') }}"+search_key,
        method: 'GET',
      }).done(function (data){
        out_put.html(data);
      }).fail(function () {
    ...
    $(document).on("click", '.delete', function(event){ 
      ...
      var click_obj=$(this);
      var url="{{ route('admin.fixedRates.delete') }}";
      var data={'id':id};
