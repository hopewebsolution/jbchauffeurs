      ...
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="navbar-right">
              <a href="{{ route('admin.sliders.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Add New</a>
          </div>
...
<script>
  $(document).ready(function(){
    $('.searchInput').on('keyup', function(){
      ...
      $.ajax({
        url : "{{ route('admin.sliders.search') }}"+search_key,
        method: 'GET',
      }).done(function (data){
        out_put.html(data);
      }).fail(function () {
    ...
    $(document).on("click", '.delete', function(event){ 
      ...
      var click_obj=$(this);
      var url="{{ route('admin.sliders.delete') }}";
      var data={'id':id};
